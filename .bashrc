...
if [ -f /var/www/.dotfiles/.bash_profile ]; then
    . /var/www/.dotfiles/.aliases
fi

if [ -f /var/www/.dotfiles/.aliases ]; then
    . /var/www/.dotfiles/.aliases
fi

if [ -f /var/www/.dotfiles/.prompt ]; then
    . /var/www/.dotfiles/.prompt
fi

if [ -f /var/www/.dotfiles/.functions ]; then
    . /var/www/.dotfiles/.functions
fi
